...
class ModulesmanagerckControllerModules extends JControllerLegacy
{
	...
	public function addModuleAjax()
	{
		...
		if ($return)
		{
			...
			$ckmodulesmanager = new CKModulesManager();echo( $ckmodulesmanager->createModule($return->id, $position, $return->title, $type) );
			return $ckmodulesmanager->createModule($return->id, $position, $return->title, $type);
		}
