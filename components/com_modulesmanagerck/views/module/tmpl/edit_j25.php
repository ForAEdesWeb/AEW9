...
<form action="index.php?option=com_modulesmanagerck&view=module&layout=message&tmpl=component" method="post" name="adminForm" id="module-form" class="form-validate">
	...
	<?php echo JHtml::_('sliders.start', 'module-sliders'); ?>
		<?php echo $this->loadTemplate('j25_options'); ?>
		<div class="clr"></div>
	...
	<div class="width-60 fltlft">
		<?php echo $this->loadTemplate('j25_assignment'); ?>
	</div>
	<?php endif; ?>
