 ...
 * @return    array
 */
function WebgalleryBuildRoute(&$query)
{
    $segments = array();
    ...
    */
    ...
    $com_menu = $menu->getItems( array('component'), array('com_webgallery') );
    ...
    foreach( $com_menu as $menuitem ):
        ...
        if( $menuitem->query['view'] == 'item' && $menuitem->query['id'] == $query['id'] ) {
            $item_menu = $menuitem ;
    ...
    foreach( $com_menu as $menuitem ):
        ...
        if( $menuitem->query['view'] == 'item' && $menuitem->query['id'] == $query['catid'] ) {
            $item_menu = $menuitem ;
            //$segments = explode( '/', $item_menu->route);
    ...
    foreach( $com_menu as $menuitem ):
        ...
        if( $menuitem->query['view'] == 'items' && $menuitem->query['id'] == $query['id'] ) {
            $cat_menu = $menuitem ;
 ...
 */
function WebgalleryParseRoute($segments)
{
    $vars = array();
    ...
    if($segments[0] == 'api') {
        ...
        include_once JPATH_ADMINISTRATOR.'/components/com_webgallery/includes/api/api.init.php' ;
