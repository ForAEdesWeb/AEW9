...
/**
 * View class for a list of Webgallery.
 *
 * @package     Joomla.Site
 * @subpackage  com_webgallery 
 */
class WebgalleryViewCategories extends AKViewList
{
    /**
    ...
    public function display($tpl = null)
    {
        ...
        foreach( $this->items as &$item ):
            ...
            // Link
            // =====================================================================================
            $item->link = new JURI("index.php?option=com_webgallery&view=items&id={$item->a_id}") ;
            ...
            if($item->a_modified_time == '0000-00-00 00:00:00') {
                $item->a_modified_time = '' ;
            }
            ...
            $item->text = $item->a_description ;
            $results = $dispatcher->trigger('onContentPrepare', array ('com_webgallery.category', &$item, &$this->params, 0));

            $results = $dispatcher->trigger('onContentAfterTitle', array('com_webgallery.category', &$item, &$item->params, 0));
            $item->event->afterDisplayTitle = trim(implode("\n", $results));

            $results = $dispatcher->trigger('onContentBeforeDisplay', array('com_webgallery.category', &$item, &$item->params, 0));
            $item->event->beforeDisplayContent = trim(implode("\n", $results));

            $results = $dispatcher->trigger('onContentAfterDisplay', array('com_webgallery.category', &$item, &$item->params, 0));
        ...
        if ($active) {
            ...
            if (!strpos($currentLink, 'view=categories') || !(strpos($currentLink, 'id='.(string) $this->category->id))) {
