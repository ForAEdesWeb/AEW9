...
?>
<form action="<?php echo JRoute::_('index.php?option=com_webgallery&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
    
    <div id="webgallery-wrap" class="windwalker list container-fluid categories<?php echo $this->get('pageclass_sfx');?>">
