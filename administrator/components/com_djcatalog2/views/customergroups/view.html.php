...
class Djcatalog2ViewCustomergroups extends JViewLegacy
{
	protected $items;
	...
	{
		JToolBarHelper::title(JText::_('COM_DJCATALOG2_CUSTOMERGROUPS'), 'generic.png');
		JToolBarHelper::addNew('customergroup.add','JTOOLBAR_NEW');
		JToolBarHelper::editList('customergroup.edit','JTOOLBAR_EDIT');
		JToolBarHelper::deleteList('', 'customergroups.delete','JTOOLBAR_DELETE');
