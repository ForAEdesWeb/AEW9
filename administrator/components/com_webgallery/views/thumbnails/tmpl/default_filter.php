...
<div id="filter-bar" class="btn-toolbar">
    ...
    <div id="search-bar" class="pull-left fltlft">
        ...
        <div class="btn-group pull-left hidden-phone">
            ...
            <?php if( $layout == 'modal' ): ?>
            <button class="btn tip" onclick="if (window.parent) window.parent.<?php echo JRequest::getVar('function') ;;?>('','<?php echo JText::_('COM_WEBGALLERY_SELECT_ITEM'); ?>');"><?php echo JText::_('COM_WEBGALLERY_MODAL_NO_SELECT'); ?></button>
            <?php endif; ?> 
        </div>
        <?php else: ?>
            ...
            <?php if( $layout == 'modal' ): ?>
            <button class="btn button" onclick="if (window.parent) window.parent.<?php echo JRequest::getVar('function') ;;?>('','<?php echo JText::_('COM_WEBGALLERY_SELECT_ITEM'); ?>');"><?php echo JText::_('COM_WEBGALLERY_MODAL_NO_SELECT'); ?></button>
            <?php endif; ?> 
        <?php endif; ?>    
    </div>
