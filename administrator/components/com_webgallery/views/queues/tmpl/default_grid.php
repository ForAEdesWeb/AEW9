...
foreach( $this->items as $i => $item ):
    ...
    // =================================================================================
        ...
        if ($item->get('a_checked_out'))
            $content .= JHtml::_('jgrid.checkedout', $i, $item->get('a_checked_out'), $item->get('a_checked_out_time'), 'queues.', $canCheckin);
        
        if ($canEdit || $canEditOwn) 
            $content .= JHtml::link(JRoute::_('index.php?option=com_webgallery&task=queue.edit&id='.$item->a_id), $item->get('a_title')) ;
        ...
        if(JVERSION >= 3) :
            ...
            if($canEdit || $canEditOwn){
                JHtml::_('dropdown.edit', $item->a_id, 'queue.');
            ...
            if($canChange || $canEditOwn) {
                if ($item->get('a_published')) :
                    JHtml::_('dropdown.unpublish', 'cb' . $i, 'queues.');
                else :
                    JHtml::_('dropdown.publish', 'cb' . $i, 'queues.');
                endif;
                    JHtml::_('dropdown.divider');
            }
            ...
            if ($item->get('a_checked_out') && $canCheckin) :
                JHtml::_('dropdown.checkin', 'cb' . $i, 'queues.');
            endif;
            
            if($canChange || $canEditOwn) {
                if ($trashed) :
                    JHtml::_('dropdown.untrash', 'cb' . $i, 'queues.');
                else :
                    JHtml::_('dropdown.trash', 'cb' . $i, 'queues.');
                endif;
            }
    ...
    // =================================================================================
        ...
        $content = JHtml::_('jgrid.published', $item->a_published, $i, 'queues.', $canChange, 'cb', $item->a_publish_up, $item->a_publish_down);
