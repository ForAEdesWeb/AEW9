...
<script type="text/javascript">
    ...
    {
        if (task == 'queue.cancel' || document.formvalidator.isValid(document.id('queue-form'))) {
...
<div id="Webgallery" class="windwalker queue editform <?php echo (JVERSION >= 3) ? 'joomla30' : 'joomla25' ?>">

<form action="<?php echo JRoute::_( JFactory::getURI()->toString() ); ?>" method="post" name="adminForm" id="queue-form" class="form-validate" enctype="multipart/form-data">    
    
    <!-- Tab Bodys -->
    <?php echo $tabs ? WebgalleryHelper::_('panel.startTabs', 'queueTab', array( 'active' => $this->fields[0] ) ) : null ; ?>
        <?php foreach( $this->fields as $key => $group ): 
                $fieldsets = $this->form->getFieldsets($group) ;
                
                echo $tabs ? WebgalleryHelper::_('panel.addPanel' , 'queueTab', $this->fields_group[$key]['label'] ? $this->fields_group[$key]['label'] : JText::_('COM_WEBGALLERY_EDIT_FIELDS_'.$group) , $group ) : null ;
        ?>
            ...
            <?php echo $tabs ? WebgalleryHelper::_('panel.endPanel' , 'queueTab' , $group ) : null ; ?>
