 ...
 * @subpackage  com_webgallery 
 */
class WebgalleryHelper extends AKProxy
{
    /**
    ...
    {        
        ...
        if($app->isAdmin()) {
            $menus['category'] = array(
                ...
                'url'      => 'index.php?option=com_categories&extension=com_webgallery',
        ...
        foreach( $folders as $folder ){
            ...
            if( substr($folder, -2) == 'es' || substr($folder, -1) == 's'){
                ...
                $menus[$folder] = array(
                    'title'    => AKHelper::_('system.getConfig', 'system.development_mode', false, 'com_webgallery')
                                    ? ucfirst($folder) . ' ' . JText::_('COM_WEBGALLERY_TITLE_LIST')
                                    : JText::_('COM_WEBGALLERY_' . strtoupper($folder) . '_TITLE' ),
                    'url'      => 'index.php?option=com_webgallery&view='.$folder,
                    'active'   => ( $vName == $folder )
                );
