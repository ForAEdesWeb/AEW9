 ...
 * @subpackage  com_webgallery 
 */
class WebgalleryModelThumbnails extends AKModelList
{
    /**
     ...
     * @var    string 
     */
    protected    $list_name = 'thumbnails' ;
    ...
    public function __construct($config = array())
    {
        ...
        // ========================================================================
        $config['tables'] = array(
            'a' => '#__webgallery_thumbnails',
            'b' => '#__webgallery_items',
        );
    ...
    protected function getListQuery()
    {
        ...
        //build query
        $q->select($select)
            ->from('#__webgallery_thumbnails AS a')
            ->leftJoin('#__webgallery_items  AS b ON a.item_id = b.id')
            //->where("")
