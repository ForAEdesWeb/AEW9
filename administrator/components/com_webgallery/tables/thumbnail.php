...
/**
 * Thumbnail Table class
 *
 * @package     Joomla.Administrator
 * @subpackage  com_webgallery 
 */
class WebgalleryTableThumbnail extends JTable
{
    /**
    ...
    {
        parent::__construct('#__webgallery_thumbnails', 'id', $db);
    }
    ...
    {
        $k = $this->_tbl_key;
        return 'com_webgallery.thumbnail.' . (int) $this->$k;
    }
    ...
    public function rebuild($parentId = null, $leftId = 0, $level = 0, $path = '')
    {
        if(!$parentId){
            ...
            $table = JTable::getInstance('Thumbnail', 'WebgalleryTable') ;
            if( !$table->load(1) ){
                $k = $this->_tbl_key;
