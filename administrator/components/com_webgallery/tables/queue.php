 ...
 * @subpackage  com_webgallery 
 */
class WebgalleryTableQueue extends JTable
{
    /**
    ...
    {
        parent::__construct('#__webgallery_queues', 'id', $db);
    }
    ...
    {
        $k = $this->_tbl_key;
        return 'com_webgallery.queue.' . (int) $this->$k;
    }
    ...
    public function rebuild($parentId = null, $leftId = 0, $level = 0, $path = '')
    {
        if(!$parentId){
            ...
            $table = JTable::getInstance('Queue', 'WebgalleryTable') ;
            if( !$table->load(1) ){
                $k = $this->_tbl_key;
