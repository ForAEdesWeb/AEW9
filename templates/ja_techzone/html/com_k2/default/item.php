  ...
  <div class="itemBody">
	  ...
	  <?php endif; ?>
		...
		<div class="itemContentFooter">
			...
			<!-- Item Hits -->
			<span class="itemHits">
				<i class="fa fa-heart-o"></i>  <b><?php echo $this->item->hits; ?></b> <?php echo JText::_('K2_TIMES'); ?>
			</span>
			<?php endif; ?>
			...
			<span class="itemDateModified">
				<i class="fa fa-clock-o"></i> <?php echo JHTML::_('date', $this->item->modified, JText::_('K2_DATE_FORMAT_LC2')); ?>
			</span>
			<?php endif; ?>
