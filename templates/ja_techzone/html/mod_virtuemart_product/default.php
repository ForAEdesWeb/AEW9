...
<div class="vmgroup<?php echo $params->get ('moduleclass_sfx') ?>">
	...
	if ($display_style == "div") {
		...
		<div class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			...
			<div class="<?php echo $pwidth ?> <?php echo $float ?> clearfix">
				<div class="spacer clearfix">
					<?php
					echo '<div class="block-image clearfix">';
		...
		<ul class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			...
			<li class="<?php echo $pwidth ?> <?php echo $float ?> clearfix <?php if($count%2): echo 'even'; else: echo 'odd'; endif; ?>">
				<?php
					echo '<div class="block-image clearfix">';
