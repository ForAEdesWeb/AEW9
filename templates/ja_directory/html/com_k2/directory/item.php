...
<div id="k2Container" class="itemDirectoryView itemView <?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
...
<div class="row">
  ...
  <div class="itemBody <?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?>">
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <?php endif; ?>
	...
	<aside class="col t3-sidebar directory-aside col-sm-4 col-md-3">
			...
			<div class="module-inner">
				<div class="module-ct">
					<?php if($latitude && $longitude): ?>
						<?php 
							$baseURL = JUri::base();
							$catParams= new JRegistry($this->item->category->params); 
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      <div class="modal-header">
					        ...
					        <h4 class="modal-title" id="mapModalLabel"><?php echo $this->item->title; ?></h4>
					      </div>
	  ...
	  <!-- Author Block -->
	  <div class="t3-module module bg-gray itemAuthorBlock">
		  <div class="module-inner">
	  ...
	  <!-- Related items by tag -->
		<div class="t3-module module bg-gray itemRelated">
