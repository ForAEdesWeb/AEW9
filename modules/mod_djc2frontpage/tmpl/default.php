<?php
/**
 * @version $Id: default.php 217 2014-01-13 08:30:22Z michal $
 * @package DJ-Catalog2
...
<div class="djf_mod djf_default" id="djf_mod_<?php echo $mid;?>">
    <div class="djf_left pull-left">
        <div class="djf_gal pull-left djc_clearfix" id="djfgal_<?php echo $mid;?>">
            <div class="djf_thumbwrapper">
                ...
                <div class="djf_row">
                    ...
                    ?>
                    <div id="djfptd_<?php echo $mid;?>_<?php echo $counter;?>" class="djc_col pull-left"></div>
                    <?php
                    $counter++;
                    }
                    ?>
        ...
        <div class="djf_img img-polaroid pull-left djc_clearfix">
            ...
            <a style="display: block" id="djfimg_<?php echo $mid;?>" <?php echo $target; ?> class="<?php echo $imgclass; ?>" href="#"></a>
            <!-- fullsize image  END -->
        </div>
