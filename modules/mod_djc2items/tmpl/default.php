		...
		<div class="djc_title">
	        <h4><?php
	        	if ($params->get('linktitle', '1') == '1') {
					echo (JHTML::link($product_url, $item->name));	
				} else {
					echo $item->name;
				}
	        ?></h4>
	    ...
	    <div class="djc_description">
            ...
            <div class="djc_price">
            	<?php if ($item->special_price) { ?>
            		<?php echo JText::_('MOD_DJC2ITEMS_PRICE').': ';?><span class="djc_price_old"><?php echo $item->price; ?></span>&nbsp;<span class="djc_price_new"><?php echo $item->special_price; ?></span>
            	<?php } else {?>
